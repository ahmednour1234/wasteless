    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction = Transaction::create([
                ...
                'success_redirect_url' => $request->input('success_redirect_url', $baseUrl . '/api/payments/callback/success'),
                'failure_redirect_url' => $request->input('failure_redirect_url', $baseUrl . '/api/payments/callback/failure'),
                'metadata' => [
